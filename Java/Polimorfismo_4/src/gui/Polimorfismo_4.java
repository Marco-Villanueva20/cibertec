...
public class Polimorfismo_4 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Polimorfismo_4 frame = new Polimorfismo_4();
	 ...
	 * Create the frame.
	 */
	public Polimorfismo_4() {
		setTitle("Polimorfismo_4");
