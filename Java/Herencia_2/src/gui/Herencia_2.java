...
public class Herencia_2 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Herencia_2 frame = new Herencia_2();
	...
	void listado(Padre x) {
		imprimir(">>>  P A D R E");
		imprimir("v1 :  " + x.v1);
		imprimir("v2 :  " + x.getv2());
		imprimir("v3 :  " + x.getv3());
		imprimir("suma :  " + x.sumaPadre());
		imprimir("producto :  " + x.productoPadre());
		imprimir("");
	}
