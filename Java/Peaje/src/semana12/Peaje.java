...
public class Peaje extends JFrame implements ActionListener {
	...
	private int cantOmnibuses,cantPasjOmnibus,cantMinivan,cantPasajMinivan,cantAutomoviles,cantPasajAutomovil;
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		//DECLARACION DE VARIABLE
				...
				//PROCESO DE CALCULO 
				efectuarIncrementos(tipoDeVehiculo,cant);
				//MOSTRAR RESULTADOS
				mostrarResultados();
				
			
	}
	private void efectuarIncrementos(int tipoDeVehiculo, double cant) {
		
			switch (tipoDeVehiculo) {
				case 0://SOLES
					cantOmnibuses ++;
					cantPasjOmnibus += cant;
					break;
				case 1://DOLARES
					cantMinivan ++;
					cantPasajMinivan += cant;
					break;

				default: //EUROS
					cantAutomoviles ++;
					cantPasajAutomovil += cant;
					break;
			}
	...
	void mostrarResultados() {
		txtS.setText("");
		imprimir("Cantidad de omnibuses                    : "+cantOmnibuses);
		imprimir("Cantidad total de pasajeros en omnibus   : "+cantPasjOmnibus);
		imprimir("Cantidad de minivanes                    : "+cantMinivan);
		imprimir("Cantidad total de pasajeros en minivan   : "+cantPasajMinivan);
		imprimir("Cantidad de automóviles                  : "+cantAutomoviles);
		imprimir("Cantidad total de pasajeros en automóvil : "+cantPasajAutomovil);
	}
}