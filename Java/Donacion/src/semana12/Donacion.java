...
public class Donacion extends JFrame implements ActionListener {
	...
	private int cantDontSoles,cantDontDolares,cantDontEuros;
	private int montoTotSoles,montoTotDolares,montoTotEuros;
	// Lanza la aplicaci�n
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		//PROCESO DE CALCULO 
		efectuarIncrementos(moneda,cant);
		//MOSTRAR RESULTADOS
		mostrarResultados();
		
	}
	private void efectuarIncrementos(int moneda, double cant) {
		switch (moneda) {
			case 0://SOLES
				cantDontSoles ++;
				montoTotSoles += cant;
	...
	void mostrarResultados() {
		txtS.setText("");
		imprimir("Cantidad de donantes en soles   : "+cantDontSoles);
		imprimir("Monto total donado en soles     : "+Alertas.df.format(montoTotSoles));
		imprimir("Cantidad de donantes en d�lares : "+cantDontDolares);
		imprimir("Monto total donado en d�lares   : "+Alertas.df.format(montoTotDolares));
		imprimir("Cantidad de donantes en euros   : "+cantDontEuros);
		imprimir("Monto total donado en euros     : "+Alertas.df.format(montoTotEuros));
	}
}