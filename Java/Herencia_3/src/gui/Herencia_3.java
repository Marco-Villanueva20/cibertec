...
public class Herencia_3 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Herencia_3 frame = new Herencia_3();
    ...
    void procesar() {
		Alumno  a = new Alumno("41524178","Marco","Salazar","12/10/1997","Jr. Larco 895 - Miraflores",23,14,16,15);
 
		listado(a);
 
		
		Docente  d = new Docente("48152356","Pedro","Rojas","25/06/1981","Av. Salaverry 388 - San Isidro",41,100,35.9);
		listado(d);
    }
